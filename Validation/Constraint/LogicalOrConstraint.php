...
class Tx_NlContact_Validation_Constraint_LogicalOrConstraint implements Tx_NlContact_Validation_ConstraintInterface {
	...
	/**
	 * @param array<Tx_NlContact_Validation_ConstraintInterface> $constraints
	 */
	...
	public function getResult($subject) {
		...
		foreach ($this->constraints as $constraint) {
			...
			if (!$constraintResult->hasErrors()) {
				return new Tx_NlContact_Validation_ValidationResult();
			} else {
